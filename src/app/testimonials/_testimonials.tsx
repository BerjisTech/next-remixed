...
const Testimonials = () => {
  ...
  useEffect(() => {
    ...
    const testimonialsShuffled = shuffleArray([...TESTIMONIALS]);
    // .slice(0, 30)
    // .map(testimonial => ({
    //     ...testimonial,
  ...
  return (
    <React.Fragment>
      ...
      <div className="bg-cards-01 dark:bg-black py-10 mt-10">
        <div className="container">
          <p className="font-bold">Finding premium clients</p>
      ...
      <div className="grid grid-cols-6 w-full gap-3 container">
        <div className="col-span-1 flex flex-col items-start justify-center">
          <div>
            ...
            <p className="w-52 text-[27.649999618530273px] font-semibold text-left text-black dark:text-accent-foreground">
      ...
      <div className="bg-cards-01 dark:bg-black py-10 mt-10">
        <div className="container">
          <p className="font-bold">Getting and giving professional advice</p>
          <div className="flex flex-col lg:flex-row gap-5 items-center my-5 relative">
            {visibleTestimonials.map((testimonial, index) => (
              <TestimonialCard key={index} testimonial={testimonial}></TestimonialCard>
            ))}
          </div>
      ...
      <div className="grid grid-cols-3 gap-10 p-20 w-[80%] m-auto container">
        <div className="col-span-2 flex justify-center items-center">
          <Image
            src="/next/next_assets/images/image-14.png"
            alt="image-14.png"
            width={560}
            height={385}
        ...
        <div className="col-span-1 col-start-3 flex items-center">
          <div>
            <p className="font-bold">How has ProZ.com changed the way you work?</p>
            <Button className="my-5">Leave a testimonial</Button>
          </div>
        </div>
      </div>

      {/* Adding enjoyment to your work */}
      <div className="bg-cards-01 dark:bg-black py-10">
        <div className="container">
          <p className="font-bold">Adding enjoyment to your work</p>
          <div className="flex flex-col lg:flex-row gap-5 items-center my-5">
            {visibleTestimonials.map((testimonial, index) => (
              <TestimonialCard key={index} testimonial={testimonial}></TestimonialCard>
            ))}
