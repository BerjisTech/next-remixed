...
import ReviewDrawer from "./_reviewDrawer";
import { Button } from "@/components/shadcn/button";

export default function ReviewsLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <div className="flex flex-col items-center min-h-screen bg-[#fbfafa]">
      <HeroSection />
      <div className="flex justify-center items-center w-full h-auto py-8 bg-[#fbfafa] dark:bg-dark">
        <div className="w-full h-auto flex-col justify-start items-center gap-4 flex max-w-[90rem]">
          {children}
          <ReviewDrawer />
          <Pagination />
