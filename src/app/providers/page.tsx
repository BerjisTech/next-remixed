...
const DirectoryPage: React.FC = () => {
  ...
  const fetchBusinesses = async (params: any) => {
    try {
      const queryString = new URLSearchParams(params).toString();
