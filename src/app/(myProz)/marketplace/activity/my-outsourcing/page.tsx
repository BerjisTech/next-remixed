            ...
            <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-3">
              <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-3">
                <div className="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-8">
                  <p className="flex-grow-0 flex-shrink-0 w-[142px] text-2xl font-semibold text-left text-[#4d9d9d]">
                    My hiring
                  </p>
                </div>
                <div
                ...
                >
                  <div className="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 bg-white">
                    ...
                    <div className="flex flex-col justify-start items-start flex-grow">
                      ...
                      <div className="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 h-[90px] relative gap-2 px-6 py-4 border-t-0 border-r-0 border-b border-l-0 border-[#eaecf0]">
                    ...
                    <div className="flex flex-col justify-start items-start flex-grow">
                      ...
                      <div className="flex flex-col justify-center items-start self-stretch flex-grow-0 flex-shrink-0 h-[90px] relative gap-[5px] px-6 py-4 border-t-0 border-r-0 border-b border-l-0 border-[#eaecf0]">
                    ...
                    <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[109px]">
                      <div className="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 h-11 gap-3 px-6 py-3 bg-white border-t-0 border-r-0 border-b border-l-0 border-[#eaecf0]">
                        <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-1">
                          <p className="flex-grow-0 flex-shrink-0 text-[10px] font-semibold text-left text-[#151515]">
                            Status
                      ...
                      <div className="flex flex-col justify-center items-center self-stretch flex-grow-0 flex-shrink-0 h-[90px] gap-2 px-6 py-4 border-t-0 border-r-0 border-b border-l-0 border-[#eaecf0]">
                        <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 relative px-2 py-0.5 rounded-2xl bg-[#fef3f2] mix-blend-multiply">
          ...
          <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-60 gap-8">
            <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 h-11 relative overflow-hidden gap-2 px-[18px] py-2.5 rounded-xl bg-[#edf5f5] border border-[#edf5f5]">
              ...
              >
                ...
                <path
                  d="M10.5 1.66669C5.89746 1.66669 2.16663 5.39752 2.16663 10C2.16663 14.6025 5.89746 18.3334 10.5 18.3334C15.1025 18.3334 18.8333 14.6025 18.8333 10C18.8333 5.39752 15.1025 1.66669 10.5 1.66669ZM14.6666 10.8334H11.3333V14.1667H9.66663V10.8334H6.33329V9.16669H9.66663V5.83335H11.3333V9.16669H14.6666V10.8334Z"
                  fill="url(#paint0_linear_16333_2252)"
                />
                <defs>
                  <linearGradient
                    id="paint0_linear_16333_2252"
                    x1="10.5"
                    y1="2.08335"
                    x2="10.5"
                    y2="18.3334"
            ...
            <div className="flex flex-col justify-start items-center self-stretch flex-grow-0 flex-shrink-0 gap-4">
              ...
              <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-[10.666666984558105px]">
                <div className="flex-grow-0 flex-shrink-0 w-40 h-40 relative">
                  ...
                  >
                    <path
                      d="M80 5.33331C89.8054 5.33331 99.5148 7.26462 108.574 11.017C117.633 14.7693 125.864 20.2692 132.797 27.2027C139.731 34.1361 145.231 42.3673 148.983 51.4263C152.735 60.4853 154.667 70.1946 154.667 80C154.667 89.8054 152.735 99.5147 148.983 108.574C145.231 117.633 139.731 125.864 132.797 132.797C125.864 139.731 117.633 145.231 108.574 148.983C99.5147 152.735 89.8054 154.667 80 154.667C70.1947 154.667 60.4853 152.735 51.4263 148.983C42.3673 145.231 34.1362 139.731 27.2027 132.797C20.2693 125.864 14.7694 117.633 11.017 108.574C7.26468 99.5147 5.33337 89.8053 5.33337 79.9999C5.33338 70.1946 7.26469 60.4852 11.0171 51.4262C14.7694 42.3673 20.2693 34.1361 27.2028 27.2026C34.1362 20.2692 42.3674 14.7693 51.4264 11.017C60.4854 7.26461 70.1947 5.33331 80.0001 5.33331L80 5.33331Z"
                      stroke="#F2F4F7"
                      strokeWidth="10.6667"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M80 5.33331C97.09 5.33331 113.663 11.1959 126.951 21.9423C140.24 32.6886 149.439 47.6683 153.015 64.3801C156.59 81.0919 154.324 98.5244 146.595 113.767C138.866 129.009 126.143 141.139 110.549 148.131C94.9545 155.124 77.4337 156.554 60.9116 152.185C44.3896 147.816 29.8663 137.912 19.7667 124.125C9.66711 110.339 4.60252 93.5052 5.41854 76.4348C6.23456 59.3643 12.8818 43.0904 24.2504 30.3302"
                      stroke="#88BDBD"
                      strokeWidth="10.6667"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  >
                    <path
                      d="M67 5.66669C75.0544 5.66669 83.0299 7.25312 90.4712 10.3354C97.9125 13.4177 104.674 17.9355 110.369 23.6308C116.065 29.3261 120.582 36.0875 123.665 43.5288C126.747 50.9701 128.333 58.9456 128.333 67C128.333 75.0544 126.747 83.03 123.665 90.4713C120.582 97.9126 116.064 104.674 110.369 110.369C104.674 116.065 97.9125 120.582 90.4712 123.665C83.0299 126.747 75.0544 128.333 66.9999 128.333C58.9455 128.333 50.97 126.747 43.5287 123.665C36.0874 120.582 29.3261 116.065 23.6307 110.369C17.9354 104.674 13.4176 97.9126 10.3353 90.4712C7.25305 83.0299 5.66662 75.0544 5.66663 67C5.66663 58.9456 7.25307 50.97 10.3354 43.5287C13.4177 36.0874 17.9354 29.3261 23.6308 23.6308C29.3261 17.9355 36.0874 13.4177 43.5287 10.3354C50.9701 7.25311 58.9456 5.66668 67 5.66669L67 5.66669Z"
                      stroke="#F2F4F7"
                      strokeWidth="10.6667"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M67 5.66669C79.5276 5.66669 91.7548 9.50293 102.037 16.6595C112.319 23.816 120.164 33.9496 124.515 45.6973C128.866 57.445 129.516 70.2435 126.376 82.3713C123.236 94.4992 116.458 105.375 106.953 113.535C97.4479 121.696 85.6718 126.75 73.2085 128.018C60.7452 129.286 48.1924 126.708 37.2385 120.629C26.2845 114.55 17.4548 105.262 11.9368 94.0153C6.41878 82.7684 4.47715 70.1014 6.37305 57.718"
                      stroke="#DCEFDC"
                      strokeWidth="10.6667"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  <p className="absolute left-[37px] top-[52.33px] text-xl font-medium text-center text-[#101828]">
                    <span className="text-xl font-medium text-center text-[#101828]">
                      Total posted
                    </span>
                    <br />
                    <span className="text-xl font-medium text-center text-[#101828]">34</span>
                  </p>
                </div>
              </div>
