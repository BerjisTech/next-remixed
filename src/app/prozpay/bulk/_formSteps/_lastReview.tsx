        ...
        <div className="flex flex-col justify-start items-start w-full gap-1.5">
          <div className="flex flex-col justify-start items-start w-full relative gap-1.5">
            <div className="flex-col justify-start items-start gap-4 inline-flex">
              ...
              <div>
                <span className="text-[#344054] text-base font-normal font-['Poppins'] leading-normal">
                  Now it's time to fund it. Please send a bank transfer of
                </span>
                <span className="gap-1 text-[#344054] text-base font-medium font-['Poppins'] leading-normal">
                  {" "}
                </span>
                <span className="text-primary text-base font-bold font-['Poppins'] leading-normal">
                  $45.43
                </span>
                <span className="gap-1 text-[#344054] text-base font-medium font-['Poppins'] leading-normal">
                  {" "}
              ...
              <div className="flex-col justify-start items-start gap-2 flex">
                <div className="text-[#344054] text-base font-semibold font-['Poppins'] leading-normal">
                ...
                <div className="p-6 bg-[#f8fbfb] rounded-xl border-l-2 border-[#c8e1e1] justify-center items-center gap-2.5 inline-flex">
                  <div className="text-[#344054] text-base font-normal font-['Poppins'] leading-normal">
              ...
              <div className="self-stretch text-[#344054] text-base font-normal font-['Poppins'] leading-normal">
