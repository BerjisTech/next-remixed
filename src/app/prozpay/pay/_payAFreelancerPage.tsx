"use client";
import PayAFreelancerForm from "@/app/prozpay/pay/_payAFreelancerForm";
import Image from "next/image";
import Link from "next/link";
import React, { useState } from "react";

const PayAFreelancer = () => {
          ...
          <div className="self-stretch flex-col justify-start items-start flex">
            ...
            <div className="self-stretch justify-start items-start gap-4 inline-flex">
              ...
              <div className="grow shrink basis-0 pt-1.5 pb-6 flex-col justify-start items-start gap-0.5 inline-flex">
                <div className="self-stretch text-sm font-medium leading-tight">Select payee</div>
              </div>
            </div>

            {/* Step 2 - Payment on behalf */}
            <div className="self-stretch justify-start items-start gap-4 inline-flex">
              <div className="self-stretch pb-1 flex-col justify-start items-center gap-1 inline-flex">
                {currentStep <= 1 ? (
                  <div
            ...
            <div className="self-stretch justify-start items-start gap-4 inline-flex">
              <div className="self-stretch pb-1 flex-col justify-start items-center gap-1 inline-flex">
                ...
                <div
                  className={`w-0.5 h-6 ${currentStep >= 3 ? "bg-primary" : "bg-gray-300"} rounded-sm`}
                ></div>
              </div>
              <div className="grow shrink basis-0 pt-1.5 pb-6 flex-col justify-start items-start gap-0.5 inline-flex">
                <div className="self-stretch text-sm font-medium leading-tight">Payment method</div>
              </div>
            </div>

            {/* Step 5 - Convenience Fee */}
            <div className="self-stretch justify-start items-start gap-4 inline-flex">
              <div className="self-stretch pb-1 flex-col justify-start items-center gap-1 inline-flex">
                {currentStep <= 4 ? (
                  <div
                    className={`w-8 h-8 bg-primary-50 ${currentStep == 4 ? "border-2 rounded-2xl border-primary" : "border-2 rounded-2xl border-gray-300"} shadow justify-center items-center inline-flex`}
                  >
                    <div className="w-7 h-7 relative bg-primary-50 rounded-2xl flex-col justify-center items-center flex">
                      <div
                        className={`w-2.5 h-2.5 ${currentStep == 4 ? "bg-primary" : "bg-gray-300"} rounded-full`}
                      ></div>
                    </div>
                  </div>
                ) : (
                ...
                <div
                  className={`w-0.5 h-6 ${currentStep >= 4 ? "bg-primary" : "bg-gray-300"} rounded-sm`}
                ></div>
              </div>
              <div className="grow shrink basis-0 pt-1.5 pb-6 flex-col justify-start items-start gap-0.5 inline-flex">
                <div className="self-stretch text-sm font-medium leading-tight">
            ...
            <div className="self-stretch justify-start items-start gap-4 inline-flex">
              <div className="self-stretch pb-1 flex-col justify-start items-center gap-1 inline-flex">
                {currentStep <= 5 ? (
                  <div
                    className={`w-8 h-8 bg-primary-50 ${currentStep == 5 ? "border-2 rounded-2xl border-primary" : "border-2 rounded-2xl border-gray-300"} shadow justify-center items-center inline-flex`}
                  >
                    <div className="w-7 h-7 relative bg-primary-50 rounded-2xl flex-col justify-center items-center flex">
                      <div
                        className={`w-2.5 h-2.5 ${currentStep == 5 ? "bg-primary" : "bg-gray-300"} rounded-full`}
                      ></div>
                    </div>
                  </div>
                ) : (
