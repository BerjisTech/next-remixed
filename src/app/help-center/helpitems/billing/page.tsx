...
const BillingPage: React.FC = () => {
  return (
    <div className="flex">
      {/* Sidebar */}
      <SidebarLayout activeItem="Billing and Payment" />

      {/* Main Content */}
      <div className="flex-1">
        {/* Hero Section */}
        <HeroSection breadcrumbs={["Help Center", "Billing and Payment"]} />

        {/* Content */}
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-6">Billing and Payment</h2>
