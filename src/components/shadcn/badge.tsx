  ...
  "inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        custom: "border-transparent bg-purple-100 text-purple-500 hover:bg-purple-200",
        destructive:
          "border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80",
        outline: "text-foreground bg-white dark:bg-dark dark:border dark:border-white",
      },
    },
    defaultVariants: {
      variant: "default",
